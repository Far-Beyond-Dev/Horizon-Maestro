...
<head>
    ...
    <title>Horizon-Maestro API</title>
    <style>
        body {{
...
<body>
    <div class="container">
    <h1>Welcome to Horizon-Maestro</h1>
    <p>Horizon-Maestro is a distributed system for managing application instances within a given worker on the Horizon-Maestro platform. Please refer to the API documentation below to get started!</p>
    </div>
