...
async fn players_by_platform() -> impl Responder {
    let data = vec![
        ...
        Series {
            ...
            data: vec![
                DataPoint { x: "01 Feb".to_string(), y: 1 },
                DataPoint { x: "02 Feb".to_string(), y: 2 },
                DataPoint { x: "03 Feb".to_string(), y: 1 },
                DataPoint { x: "04 Feb".to_string(), y: 1 },
                DataPoint { x: "05 Feb".to_string(), y: 2 },
                DataPoint { x: "06 Feb".to_string(), y: 1 },
